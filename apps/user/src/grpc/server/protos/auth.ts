...
export const COM_BASE_GRPC_NODEJS_USER_AUTH_PACKAGE_NAME = "com.base.grpc.nodejs.user.auth";

export interface AuthServiceClient {
  validateToken(request: ValidateTokenDTO, metadata?: Metadata): Observable<ValidateTokenResponse>;
}
