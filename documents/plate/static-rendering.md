...
Source: https://platejs.org/docs/static
...
export default async function Page() {
  ...
  const serverContent = [
    ...
    {
      type: "p",
      children: [{ text: "This content is static and server-rendered." }],
    },
  ];
  ...
  return (
    <PlateStatic editor={editor} className="my-static-preview-container" />
  );
}
```
