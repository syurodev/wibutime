 ...
 * Filter controls for history content with URL state sync
 */
...
export interface HistoryFiltersProps {
  ...
  readonly currentSort: HistorySortOption;
}
      ...
      <div className="flex items-center gap-3">
        ...
        <Select value={currentSort} onValueChange={handleSortChange}>
          ...
          <SelectContent>
            ...
            <SelectItem value="updated">{t("sortOptions.updated")}</SelectItem>
          </SelectContent>
        </Select>
      </div>
    </div>
