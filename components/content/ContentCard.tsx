...
import { ContentFormatter } from "@/lib/api/models/content";
				...
				<div className="p-2 flex flex-col justify-between h-full">
					...
					<div className="mt-1 flex items-center justify-between">
						<div className="flex text-xs items-center justify-center w-fit gap-1">
							...
							<span>{ContentFormatter.formatViews(series.views)}</span>
						</div>
						<div className="flex text-xs items-center justify-center w-fit gap-1">
							<Heart className="size-4 text-rose-500" />
							<span>{ContentFormatter.formatFavorites(series.favorites)}</span>
						</div>
					</div>
				</div>
			</AspectRatio>
