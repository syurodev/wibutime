...
export default function Nav({ items = [] }: NavProps) {
    ...
    return (
        <motion.nav
            className="fixed inset-x-0 z-[99999] mx-auto w-fit bg-white/80 backdrop-blur-md border border-gray-200/50 rounded-full shadow-lg"
            style={{ bottom: "1rem" }}
                                ...
                                >
                                    ...
                                    >
                                        <motion.div
                                            ...
                                            whileHover="hover"
                                        >
                                            <Icon className="w-5 h-5 text-gray-600 group-hover:text-gray-900 transition-colors duration-200" />
                                        </motion.div>
                                    </Link>
                                </motion.div>
                            );
