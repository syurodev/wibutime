...
const ContentDetailHeroSection = () => {
  return (
    <div className="flex flex-col gap-4 h-dvh overflow-y-auto px-4 pt-[82px] w-full max-w-[1300px] mx-auto pb-4">
      <div className="flex flex-col gap-4 md:flex-row">
        <div className="relative w-[300px] h-[450px] mx-auto rounded-lg overflow-hidden shadow flex-none">
          <Image
            src={
        ...
        <Card className="min-w-[300px] h-fit">
          ...
          <CardContent>
            ...
            <div className="text-sm">
              ...
              <p>
                Đây là project đầu tay của mình. Hy vọng các bạn sẽ có thể đưa
                ra lời đánh giá cả tích cực lẫn tiêu cực để mình có thể hoàn
                thiện bộ truyện này nhé.
              </p>
              <p>
