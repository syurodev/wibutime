  ...
  const resolveElement = (node: TElement, index: number) => {
    ...
    const applyScrollCompensation = (
      ...
      if (scrollLeft > 0) {
        ...
        const originalStyles = globalThis.window.getComputedStyle(original);
...
const calculatePreviewTop = (
  ...
  const editorPaddingTop = Number(
    globalThis.window.getComputedStyle(editable).paddingTop.replace("px", "")
  );
  ...
  const firstMarginTopString =
    globalThis.window.getComputedStyle(firstDomNode).marginTop;
  ...
  const currentMarginTopString =
    globalThis.window.getComputedStyle(child).marginTop;
